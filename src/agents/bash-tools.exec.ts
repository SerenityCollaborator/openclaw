...
export function createExecTool(
  ...
  return {
    ...
    label: "exec",
    description:
      "Execute shell commands with background continuation. Use yieldMs/background to continue later via process tool. Use pty=true for TTY-required commands (terminal UIs, coding agents). For long-running processes (dev servers, watchers, daemons) that should survive session ends, prefer the task_runner tool instead.",
